...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto w-full max-w-6xl px-4 sm:px-6 md:px-8 pb-24 pt-24">
        <section className="relative mb-6 overflow-hidden rounded-[32px] border border-black/[0.06] bg-[#FBFBFD] p-8 shadow-[0_28px_80px_rgba(15,23,42,0.08)] dark:border-white/[0.08] dark:bg-[#0F0F11] dark:shadow-[0_28px_80px_rgba(0,0,0,0.32)] sm:p-10">
          ...
          <div className="relative grid gap-8 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-start 2xl:grid-cols-[minmax(0,1.16fr)_320px]">
            <div className="max-w-2xl min-w-0">
              ...
              <h1 className="mt-4 max-w-3xl font-display text-[30px] font-semibold tracking-tight text-foreground sm:text-[38px] xl:text-[46px] leading-[1.06] truncate">
